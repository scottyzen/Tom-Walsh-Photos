...
<head>
    ...
    <link href="<?php
                echo get_template_directory_uri() . '/core/hamburgers.css' ?>" rel="stylesheet">
    <?php wp_head(); ?>
</head>
        ...
        <?php } ?>')">
            ...
            <div class="frosted-glass">
                <div class="container flex justify-between items-center">
                    ...
                    <nav class="menu font-medium hidden md:block">
                        <ul id="main-menu" class="justify-end">
                            ...
                            <li class="mr-1 ml-8 hidden sm:block" style="margin-top: -3px">
                                <a href="https://www.instagram.com/tomwalshphotos/" target=”_blank”>
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 32 32" style=" fill:#fff;">
                                        <g>
                ...
                <div class="container mobile-nav md:hidden">
                    <ul class="text-grey-lightest text-center text-xl font-medium">
                        <li class="p-2 my-6">
                            <a href="<?php echo get_site_url() ?>" class="border-b-2 py-1 hover:border-orange">About Me</a>
                        </li>
                        <li class="p-2 my-6">
                            <a href="<?php echo get_site_url() ?>/gallery" class="border-b-2 py-1 hover:border-orange">Gallery</a>
                        </li>
                        <li class="p-2 my-6">
                            <a href="<?php echo get_site_url() ?>/contact" class="border-b-2 py-1 hover:border-orange">Contact</a>
                        </li>
                    </ul>
                    <ul class="w-full text-grey-lightest text-center flex justify-center py-8 pb-12">
                        <li class="mx-2 pb-4">
                            <a href="https://www.instagram.com/tomwalshphotos/" target=”_blank”>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 32 32" style=" fill:#fff;">
                                    <g>
                                        <path d="M 11.46875 5 C 7.917969 5 5 7.914063 5 11.46875 L 5 20.53125 C 5 24.082031 7.914063 27 11.46875 27 L 20.53125 27 C 24.082031 27 27 24.085938 27 20.53125 L 27 11.46875 C 27 7.917969 24.085938 5 20.53125 5 Z M 11.46875 7 L 20.53125 7 C 23.003906 7 25 8.996094 25 11.46875 L 25 20.53125 C 25 23.003906 23.003906 25 20.53125 25 L 11.46875 25 C 8.996094 25 7 23.003906 7 20.53125 L 7 11.46875 C 7 8.996094 8.996094 7 11.46875 7 Z M 21.90625 9.1875 C 21.402344 9.1875 21 9.589844 21 10.09375 C 21 10.597656 21.402344 11 21.90625 11 C 22.410156 11 22.8125 10.597656 22.8125 10.09375 C 22.8125 9.589844 22.410156 9.1875 21.90625 9.1875 Z M 16 10 C 12.699219 10 10 12.699219 10 16 C 10 19.300781 12.699219 22 16 22 C 19.300781 22 22 19.300781 22 16 C 22 12.699219 19.300781 10 16 10 Z M 16 12 C 18.222656 12 20 13.777344 20 16 C 20 18.222656 18.222656 20 16 20 C 13.777344 20 12 18.222656 12 16 C 12 13.777344 13.777344 12 16 12 Z "></path>
                                    </g>
                                </svg>
